...
class Env:
    ...
    unitTestingFileName             = os.environ.get('UNIT_TESTING_FILE_NAME')
    sharedFunctionsFileName         = os.environ.get('SHARED_FUNCTIONS_FILE_NAME')
    datasetRegistrationFileName     = os.environ.get('DATASET_REGISTRATION_FILE_NAME')
    trainingFileName                = os.environ.get('TRAINING_FILE_NAME')
    modelRegistrationFileName       = os.environ.get('MODEL_REGISTRATION_FILE_NAME')
    metricsOutputFileName           = os.environ.get('METRICS_OUTPUT_FILE_NAME')
    projectFolder                   = os.environ.get('PROJECT_FOLDER')
    scriptFolder                    = os.environ.get('SCRIPTS_FOLDER')
